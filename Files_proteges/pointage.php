          ...
          if(empty($data)){
              if(isset($_POST['pMatin'])){
                ...
                $timestamp = date('h:i:s'); 
                  ...
                  $addTime = $bdd->prepare("INSERT INTO `pointage` (`id`, `user`, `jour`, `startTime`, `finish`,`nom`,`prenom` ) VALUES (NULL, $id, CURRENT_DATE, CURRENT_TIME, '','$_SESSION['nom']','$_SESSION['prenom']')");
                  $addTime->execute(array(NULL, $id, 'CURRENT_DATE', 'CURRENT_TIME', '',$_SESSION['nom'],$_SESSION['prenom']));
